                                    ...
                                    {isBiddingOpen ? (
                                        <div className="space-y-4">
                                            <div className="relative">
                                                <label className="text-xs font-semibold text-gray-700 ml-1 mb-1 block">Your Offer (₹/kg)</label>
                                                <div className="relative group">
                                                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 font-bold text-lg group-focus-within:text-green-600 transition-colors">₹</span>
                                                    <input
                                                        type="number"
                                                        placeholder={(highestBid + 1).toString()}
                                                        className="w-full pl-10 pr-4 py-4 text-xl font-bold border-2 border-gray-200 rounded-xl focus:border-green-500 focus:ring-4 focus:ring-green-500/10 outline-none transition-all"
                                                        value={bidAmount}
                                                        onChange={(e) => setBidAmount(e.target.value)}
                                                    />
                                                </div>
                                                <p className="text-[10px] text-gray-400 mt-1 ml-1 text-right">
                                                    Min required: ₹{highestBid + 1}
                                                </p>
                                            </div>

                                            <Button
                                                className="w-full h-14 text-lg bg-gradient-to-r from-green-600 to-emerald-700 hover:from-green-700 hover:to-emerald-800 shadow-lg shadow-green-600/20 rounded-xl transition-all active:scale-[0.98]"
                                            ...
                                            >
                                                {placingBid ? (
                                                    ...
                                                    <span className="flex items-center gap-2">Place Winning Bid <ArrowUpRight className="h-5 w-5"/></span>
                                                )}
                                            </Button>
                                        </div>
                                    ) : (
                                        <div className="p-4 bg-gray-100 rounded-xl text-center text-gray-500">
                                            ...
                                            <p className="text-xs">No further actions allowed</p>
                                        </div>
                                    )}

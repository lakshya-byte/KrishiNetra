  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 animate-fade-in">
      ...
      <div className="bg-white rounded-xl p-8 shadow-sm text-center">
        ...
        <h2 className="text-[#0F1419] mb-1">Raju Kumar</h2>
        <p className="text-[#666666] text-sm mb-3">Farmer since 2020</p>
        <div className="flex items-center justify-center gap-2">
          ...
          <span className="text-[#666666] text-sm">4.8/5 from 142 reviews</span>
        </div>
      </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                {isEditMode ? (
                  ...
                  <div className="text-[#0F1419]">+91-9876543210</div>
                )}
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                {isEditMode ? (
                  ...
                  <div className="text-[#0F1419]">raju@krishinetra.io</div>
                )}
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                {isEditMode ? (
                  ...
                  <div className="text-[#0F1419]">
                    Village Rampur, District Amritsar, Punjab, India - 143001
                  </div>
                )}
              </div>
            </div>
